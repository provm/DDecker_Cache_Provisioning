...
ssh ubuntu@10.0.3.25 /home/ubuntu/ycsb/bin/ycsb load redis -s -P /home/ubuntu/ycsb/workloads/workload1 -p "redis.host=10.0.3.168" -p "redis.port=6379" >> /root/ddecker/Memory_Cache/redis/redis_${1}.out 2>&1
