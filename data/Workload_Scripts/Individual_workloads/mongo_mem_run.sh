...
do
   name="c5"
   echo "========== START: Container $i Memory STATS ==============" > /root/ddecker/Memory_Cache/mongo/mongo_${1}.out
...
do
   name="c5"
   echo "========== STOP: Container $i Memory STATS ==============" >> /root/ddecker/Memory_Cache/mongo/mongo_${1}.out
   cat /sys/fs/cgroup/memory/lxc/$name/memory.stat >> /root/ddecker/Memory_Cache/mongo/mongo_${1}.out
   echo "======== END Container STATS ======" >> /root/ddecker/Memory_Cache/mongo/mongo_${1}.out
done
