...
echo 25 > /sys/fs/cgroup/memory/lxc/c3/hcache_weight
...
ssh ubuntu@10.0.3.47 /home/ubuntu/filebench-1.4.9.1/filebench -f /home/ubuntu/filebench-1.4.9.1/workloads/webserver1.f >> /root/ddecker/Final_Results/app_perf/setup4/webserver_${1}.out 2>&1 
