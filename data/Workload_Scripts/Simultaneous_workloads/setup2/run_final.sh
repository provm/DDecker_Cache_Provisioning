...
ssh ubuntu@10.0.3.47 /home/ubuntu/filebench-1.4.9.1/filebench -f /home/ubuntu/filebench-1.4.9.1/workloads/webserver.f >> /root/ddecker/Final_Results/setup2/webserver_${1}.out 2>&1 &
